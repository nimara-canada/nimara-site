...
const Privacy = () => {
  return (
    <div className="min-h-screen flex flex-col">
      <Helmet>
        <title>Privacy Policy — Data Storage, Rights & Choices | Nimara</title>
        <meta name="description" content="What we collect, why, where we store it (Canada), how long we keep it (7 years for project records), and your rights under PIPEDA." />
        
        <link rel="canonical" href="https://nimara.ca/privacy" />
        
        <meta property="og:site_name" content="Nimara" />
        <meta property="og:title" content="Privacy Policy — Data Storage, Rights & Choices" />
        <meta property="og:description" content="What we collect, why, where we store it (Canada), how long we keep it (7 years for project records), and your rights under PIPEDA." />
        ...
        <meta name="twitter:title" content="Privacy Policy — Data Storage, Rights & Choices" />
        <meta name="twitter:description" content="What we collect, why, where we store it (Canada), how long we keep it (7 years for project records), and your rights under PIPEDA." />
