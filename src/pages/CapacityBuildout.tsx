...
import { MotionPreferencesProvider, useStaggeredReveal, TIMING } from '@/hooks/use-scroll-reveal';
import { CALENDLY_BOOKING_URL, TYPEFORM_HEALTH_CHECK_URL, CONTACT_EMAIL } from '@/constants/urls';
import { Check, X, ArrowRight, FileCheck, ClipboardCheck, Users, Sparkles, Building2, DollarSign, UserCog, Briefcase, Database, Heart, HandHeart, Shield, Clock, Mail, ChevronDown, GraduationCap } from 'lucide-react';
...
const ScrollSection = ({
  ...
  return <motion.div ref={ref} style={fadeIn ? {
    y,
    opacity,
    scale
  } : {
  ...
  return <motion.div initial={{
    ...
    ease: [0.22, 1, 0.36, 1]
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        ...
        <motion.a href={CALENDLY_BOOKING_URL} target="_blank" rel="noopener noreferrer" whileHover={{
        scale: 1.02
      }} whileTap={{
        scale: 0.98
...
const HeroSection = () => {
  const {
    ref,
    getItemStyle
  } = useStaggeredReveal<HTMLElement>(8, {
    staggerDelay: 100,
    baseDelay: 150
  });
  return <section id="hero" ref={ref} className="min-h-[100vh] bg-nim-cloud relative overflow-hidden flex items-center pt-20">
      <div className="relative z-10 w-full max-w-4xl mx-auto px-6 lg:px-8 py-20 lg:py-28">
        <div className="text-center">
          {/* Tag */}
          <motion.div style={getItemStyle(0)} className="inline-flex items-center gap-2 px-4 py-2 bg-nim-mint/30 border border-nim-mint rounded-full mb-8">
          ...
          {/* Headline */}
          <motion.h1 style={getItemStyle(1)} className="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold text-nim-navy leading-[1.1] tracking-[-0.02em] mb-6">
            Be proof-ready before funders ask in 4 weeks
          </motion.h1>

          {/* Subhead */}
          <motion.p style={getItemStyle(2)} className="text-lg sm:text-xl text-nim-slate-dark max-w-2xl mx-auto leading-relaxed mb-4">
            We set up your board records, grant tracking, team files, and volunteer systems — then train your staff to keep it running.
          </motion.p>

          {/* Support line */}
          <motion.p style={getItemStyle(3)} className="text-sm text-nim-slate mb-10">
            Pick the areas you need most. Start with 2. Add more anytime.
          </motion.p>

          {/* CTAs */}
          <motion.div style={getItemStyle(4)} className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-8">
            {/* Primary CTA */}
            <motion.a href={CALENDLY_BOOKING_URL} target="_blank" rel="noopener noreferrer" whileHover={{
            scale: 1.02
          }} whileTap={{
            ...
            {/* Secondary CTA */}
            <a href={TYPEFORM_HEALTH_CHECK_URL} target="_blank" rel="noopener noreferrer" className="group inline-flex items-center gap-1.5 py-3.5 px-4 text-nim-slate hover:text-nim-navy transition-colors">
          ...
          {/* Trust badges */}
          <motion.div style={getItemStyle(5)} className="flex flex-wrap items-center justify-center gap-4 text-xs text-nim-slate">
...
const HowItWorksSection = () => {
  ...
  return <section id="how-it-works" ref={ref} className="py-24 md:py-32 bg-[#F8F9FC] relative">
      <div className="max-w-6xl mx-auto px-6 lg:px-8">
        {/* Section header */}
        <div className="text-center mb-16 md:mb-20">
          <motion.span style={getItemStyle(0)} className="inline-block text-xs font-semibold uppercase tracking-[0.2em] text-nim-purple mb-4">
            The Process
          </motion.span>
          <motion.h2 style={getItemStyle(1)} className="text-3xl sm:text-4xl md:text-5xl font-bold text-nim-navy tracking-tight mb-5">
            How it works
          </motion.h2>
          <motion.p style={getItemStyle(2)} className="text-lg md:text-xl text-[#1A1A1A]/70 max-w-xl mx-auto leading-relaxed">
            We learn your org first. Then we build what you actually need.
          </motion.p>
        </div>

        {/* Steps grid */}
        <motion.div style={getItemStyle(3)} className="relative">
          ...
          <div className="grid md:grid-cols-3 gap-8 md:gap-12">
            ...
            delay: index * 0.1
                ...
                {index < steps.length - 1 && <div className="md:hidden absolute left-1/2 -translate-x-1/2 top-[72px] w-px h-8 border-l-2 border-dashed border-nim-purple/20" />}
        ...
        {/* Footer line */}
        <motion.p style={getItemStyle(4)} className="text-center text-sm text-[#1A1A1A]/50 mt-16 md:mt-20 max-w-2xl mx-auto leading-relaxed">
...
const DomainsSection = () => {
  const {
    ref,
    getItemStyle
  } = useStaggeredReveal<HTMLElement>(12, {
    staggerDelay: 50,
    baseDelay: 100
  });
  const domains = [{
  ...
  return <section id="domains" ref={ref} className="py-24 md:py-32 bg-white relative">
      <div className="max-w-5xl mx-auto px-6 lg:px-8">
        {/* Section header - centered */}
        <div className="text-center mb-16 md:mb-20">
          <motion.p style={getItemStyle(0)} className="text-nim-purple text-sm font-medium tracking-wide mb-4">
            What We Fix
          </motion.p>
          <motion.h2 style={getItemStyle(1)} className="text-3xl md:text-4xl lg:text-5xl font-bold text-nim-navy tracking-tight mb-6">
            7 areas. You choose.
          </motion.h2>
          <motion.p style={getItemStyle(2)} className="text-lg text-nim-slate max-w-xl mx-auto">
            Pick where you need the most help. We handle the rest.
          </motion.p>
        </div>

        {/* Domain list - clean vertical stack */}
        <motion.div style={getItemStyle(3)} className="space-y-4">
          {domains.map((domain, index) => {
          const IconComponent = domain.icon;
          return <motion.div key={domain.id} initial={{
            opacity: 0,
            y: 12
          }} whileInView={{
            opacity: 1,
            ...
            duration: 0.4,
            delay: index * 0.03
          }} className={`group grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 p-6 lg:p-8 rounded-2xl border transition-all duration-200 ${domain.popular ? 'bg-nim-mint/5 border-nim-mint/40 hover:border-nim-mint' : 'bg-white border-nim-mist hover:border-nim-slate/30'}`}>
                {/* Left: Icon + Title + Badge */}
                <div className="lg:col-span-4 flex items-start gap-4">
                  <div className={`w-11 h-11 rounded-xl flex items-center justify-center flex-shrink-0 ${domain.popular ? 'bg-nim-mint/30' : 'bg-nim-cloud'}`}>
                  ...
                  <div>
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      {domain.popular && <span className="px-2 py-0.5 bg-nim-mint text-nim-navy text-[10px] font-bold uppercase tracking-wide rounded">
                          Popular
                        </span>}
                    </div>
                ...
                <div className="lg:col-span-4">
                  ...
                  <div className="flex flex-wrap gap-1.5">
                    {domain.includes.map((item, i) => <span key={i} className="inline-block px-2.5 py-1 bg-nim-cloud/80 text-nim-navy/80 text-xs rounded-md">
                        {item}
                      </span>)}
                  </div>
                </div>
        ...
        {/* Footer CTA */}
        <motion.div style={getItemStyle(4)} className="mt-16 text-center">
          <p className="text-nim-slate mb-4">
            Not sure which areas you need?
          </p>
          <a href={TYPEFORM_HEALTH_CHECK_URL} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-6 py-3 bg-nim-navy text-white font-medium rounded-xl hover:bg-nim-navy/90 transition-colors group">
...
const PricingTiersSection = () => {
  ...
  const tiers = [{
    ...
    features: ["Board & Governance setup", "Money & Grants (Proof Pack system)", "Programs & Ops basics", "4–5 week timeline"],
    bgColor: "bg-white",
    ...
    features: ["Everything in Starter", "People (Staff & HR)", "Tools & Data setup", "90-Day Ops Insurance included"],
    ...
    features: ["Everything in Core 5", "Fundraising & Donors (Optional)", "Volunteers (Optional)", "6–10 week timeline"],
    bgColor: "bg-white",
    borderColor: "border-nim-mist",
  ...
  return <section id="pricing" ref={ref} className="py-20 md:py-28 bg-nim-cloud relative">
      <div className="max-w-6xl mx-auto px-6 lg:px-8">
        {/* Section header */}
        <div className="text-center mb-14 md:mb-20">
          <motion.h2 style={getItemStyle(0)} className="text-3xl sm:text-4xl md:text-5xl font-bold text-nim-navy tracking-tight mb-4">
            Simple pricing. No hidden fees.
          </motion.h2>
          <motion.p style={getItemStyle(1)} className="text-lg text-nim-slate max-w-2xl mx-auto">
        ...
        {/* Tier cards */}
        <motion.div style={getItemStyle(2)} className="grid md:grid-cols-3 gap-6 lg:gap-8 mb-12">
          {tiers.map(tier => <motion.div key={tier.name} whileHover={{
          y: -6
        }} transition={{
          type: "spring",
          stiffness: 300,
          damping: 25
              ...
              <div className="flex flex-col h-full">
                {/* Badge */}
                <span className={`inline-block w-fit px-3 py-1 text-[10px] font-bold uppercase tracking-wide rounded-full mb-6 ${tier.highlighted ? "bg-nim-navy text-white" : "bg-nim-mist text-nim-navy"}`}>
                  {tier.badge}
                </span>
                ...
                {/* CTA */}
                <motion.a href={tier.ctaLink} target="_blank" rel="noopener noreferrer" whileHover={{
              scale: 1.02
            }} whileTap={{
              scale: 0.98
            }} className={`w-full inline-flex items-center justify-center gap-2 px-6 py-3.5 font-semibold rounded-xl transition-all ${tier.highlighted ? "bg-nim-mint text-nim-navy hover:bg-nim-mint/90" : "bg-nim-navy text-white hover:bg-nim-navy/90"}`}>
                  {tier.ctaText}
                  <ArrowRight className="w-4 h-4" />
                </motion.a>
              </div>
        ...
        {/* Payment line */}
        <motion.p style={getItemStyle(3)} className="text-center text-sm font-medium text-nim-navy mb-6">
          50% to start. 50% at delivery. Invoiced as capacity building.
        </motion.p>

        {/* ROI line */}
        <motion.div style={getItemStyle(4)} className="max-w-2xl mx-auto bg-white border border-nim-mist rounded-xl p-6 mb-8">
        ...
        {/* Escape hatch */}
        <motion.div style={getItemStyle(5)} className="text-center space-y-2">
          <a href={TYPEFORM_HEALTH_CHECK_URL} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-nim-slate hover:text-nim-navy transition-colors group">
          ...
          <p className="text-xs text-nim-slate/70">
            ...
            <a href="https://nimara.ca" target="_blank" rel="noopener noreferrer" className="underline hover:text-nim-navy transition-colors">
              nimara.ca
            </a>
          </p>
        </motion.div>
...
const WhatWeInstallSection = () => {
  ...
  return <section id="what-we-install" ref={ref} className="py-20 md:py-28 bg-muted/30 relative">
      <div className="max-w-5xl mx-auto px-6 lg:px-8">
        {/* Section header */}
        <div className="text-center mb-12 md:mb-16">
          <motion.span style={getItemStyle(0)} className="inline-block text-xs font-semibold uppercase tracking-widest text-primary mb-3">
            Deliverables
          </motion.span>
          <motion.h2 style={getItemStyle(1)} className="text-3xl sm:text-4xl font-bold text-foreground tracking-tight mb-4">
            What we install (not just advise)
          </motion.h2>
          <motion.p style={getItemStyle(2)} className="text-lg text-muted-foreground max-w-2xl mx-auto">
        ...
        <div className="space-y-4 mb-8">
          {domains.map((domain, index) => <motion.div key={domain.number} style={getItemStyle(3 + index)} className="bg-card border border-border rounded-xl p-5 lg:p-6">
        ...
        <motion.div style={getItemStyle(8)} className="bg-primary/[0.04] border border-primary/20 rounded-xl p-5 lg:p-6 mb-10">
          <div className="flex items-start gap-4">
            {/* Icon */}
        ...
        {/* Closing line */}
        <motion.div style={getItemStyle(9)} className="text-center">
        ...
        {/* Disclaimer row */}
        <motion.p style={getItemStyle(10)} className="text-center text-xs text-muted-foreground/50 mt-10">
...
const SixWeekProcessSection = () => {
  ...
  const {
    ref,
    getItemStyle
  } = useStaggeredReveal<HTMLElement>(10, {
    staggerDelay: 60,
    baseDelay: 100
  });
  const weeks = [{
    ...
    bullets: ["Install tracker + folder map + naming rules", "Confirm grants, reporting needs, and approvals", "Quick win: first \"Proof Pack\" folder set up"]
  }, {
    id: "week-2",
    title: "Week 2 — Build with real data",
    bullets: ["Connect spending to invoices, receipts, and approvals", "Set coding rules so reports match records", "Start populating proof packs"]
  }, {
    id: "week-3",
    title: "Week 3 — Make routines simple",
    bullets: ["Budget vs actual setup + month-end checklist", "Draft micro-SOPs (short steps people follow)", "Clean handoffs between staff"]
  }, {
    id: "week-4",
    title: "Week 4 — Train and roll out",
    bullets: ["Train staff on the routine + proof packs", "Start using the system in real work", "Fix confusion fast"]
  }, {
    id: "week-5",
    title: "Week 5 — Stabilize",
    bullets: ["Tighten rules, permissions, and file hygiene", "Review one full grant proof pack end-to-end", "Reduce \"special cases\" that break the process"]
  }, {
    id: "week-6",
    title: "Week 6 — Handoff + prove it works",
    bullets: ["Run a \"Funder Request Drill\" (pull proof fast)", "Finalize SOPs + handoff guide", "Set the 90-day support plan (Core 5)"]
  }];
  const requiredInputs = ["List of active grants (or top 3–5)", "Access to current files (Drive/SharePoint)", "Your current tracking method (sheet/QBO/etc.)", "1–2 staff champions to meet weekly"];
  const outcomes = ["Proof packs you can pull fast", "Clean tracking that matches reporting", "Clear steps (SOPs) your team follows", "Staff trained to run the system"];
  return <section id="six-week-process" ref={ref} className="py-20 md:py-28 bg-background relative">
      <div className="max-w-6xl mx-auto px-6 lg:px-8">
        {/* Section header */}
        <div className="text-center mb-12 md:mb-16">
          <motion.h2 style={getItemStyle(0)} className="text-3xl sm:text-4xl font-bold text-foreground tracking-tight mb-4">
            How the 6-week install works
          </motion.h2>
          <motion.p style={getItemStyle(1)} className="text-lg text-muted-foreground">
        ...
        <div className="grid lg:grid-cols-[1fr_320px] gap-10 lg:gap-12">
          ...
          <motion.div style={getItemStyle(2)}>
            <div className="space-y-3">
              {weeks.map(week => <div key={week.id} className={`border rounded-xl overflow-hidden transition-colors ${openWeek === week.id ? "border-primary/30 bg-primary/[0.02]" : "border-border bg-card"}`}>
                  <button onClick={() => setOpenWeek(openWeek === week.id ? "" : week.id)} className="w-full flex items-center justify-between px-5 py-4 text-left">
                    <span className={`font-semibold ${openWeek === week.id ? "text-foreground" : "text-muted-foreground"}`}>
                      {week.title}
                    </span>
                    <ChevronDown className={`w-5 h-5 text-muted-foreground transition-transform ${openWeek === week.id ? "rotate-180" : ""}`} />
                  </button>
                ...
                ease: "easeInOut"
                    ...
                    <div className="px-5 pb-4">
                      <ul className="space-y-2">
                        {week.bullets.map((bullet, i) => <li key={i} className="flex items-start gap-3 text-sm text-muted-foreground">
          ...
          <div className="space-y-5">
            ...
            <motion.div style={getItemStyle(3)} className="bg-card border border-border rounded-xl p-5">
              <h3 className="text-base font-semibold text-foreground mb-4">
                What we need from you
              </h3>
              <ul className="space-y-2.5">
                {requiredInputs.map((item, i) => <li key={i} className="flex items-start gap-3 text-sm text-muted-foreground">
            ...
            {/* What you get card */}
            <motion.div style={getItemStyle(4)} className="bg-primary/[0.04] border border-primary/20 rounded-xl p-5">
              <h3 className="text-base font-semibold text-foreground mb-4">
                What you'll have by Week 6
              </h3>
              <ul className="space-y-2.5">
                {outcomes.map((item, i) => <li key={i} className="flex items-start gap-3 text-sm text-muted-foreground">
                    <Check className="w-4 h-4 text-primary mt-0.5 flex-shrink-0" strokeWidth={2.5} />
                    <span>{item}</span>
                  </li>)}
              </ul>
        ...
        {/* CTA row */}
        <motion.div style={getItemStyle(5)} className="mt-12 text-center">
          <motion.a href={CALENDLY_BOOKING_URL} target="_blank" rel="noopener noreferrer" whileHover={{
          scale: 1.02
        }} whileTap={{
          scale: 0.98
          ...
          <div className="mt-4">
            <a href={TYPEFORM_HEALTH_CHECK_URL} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1.5 text-sm text-muted-foreground hover:text-foreground transition-colors group">
              <span className="relative">
...
const WhoThisIsFor = () => {
  const forYou = ["You're a Canadian nonprofit or charity", "You have 0–25 staff (or heavy volunteer ops)", "You have grants or funder reporting requirements", "Receipts, approvals, and files are scattered across inboxes", "Your reports don't match your records", "You want one simple system your team will actually use"];
  const notForYou = ["You're looking for guaranteed funding (we don't do that)", "You want a big report but no operational change", "You need legal, tax, or CRA advice (not our thing)", "You need a full bookkeeping cleanup (we're not accountants)", "You're over 25 staff (we work with small teams only)"];
  return <section id="who-its-for" className="py-24 md:py-32 bg-nim-cloud relative overflow-hidden">
      <div className="relative max-w-5xl mx-auto px-6 lg:px-12">
        ...
        <div className="grid lg:grid-cols-2 gap-6 lg:gap-8">
          ...
          damping: 25
            ...
            <div className="space-y-3">
              {forYou.map((item, index) => <div key={index} className="flex items-start gap-3">
                  <Check className="w-4 h-4 text-nim-purple mt-0.5 flex-shrink-0" strokeWidth={2.5} />
          ...
          delay: 0.1
            ...
            <div className="space-y-3">
              {notForYou.map((item, index) => <div key={index} className="flex items-start gap-3">
...
const OutcomeSection = () => {
  const outcomes = [{
    icon: FileCheck,
    title: "Pull proof fast",
    desc: "Invoices, receipts, approvals in one place"
  }, {
    icon: ClipboardCheck,
    title: "Reports match records",
    desc: "Budget vs actual is clean"
  }, {
    icon: Users,
    title: "Clear roles + approvals",
    desc: "People know the steps"
  }, {
    icon: Sparkles,
    title: "New staff can onboard fast",
    desc: "Files and SOPs are obvious"
  }];
  return <section id="outcomes" className="py-24 md:py-32 bg-white relative overflow-hidden">
      <div className="relative max-w-6xl mx-auto px-6 lg:px-12">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5 lg:gap-6">
          {outcomes.map((item, index) => <motion.article key={index} initial={{
          opacity: 0,
          y: 20
        }} whileInView={{
          opacity: 1,
...
const FrameworkSection = () => {
  const coreAreas = [{
    icon: Building2,
    title: "Board & Governance",
    desc: "Clear decisions, minutes, and follow-through.",
    optional: false
  }, {
    icon: DollarSign,
    title: "Money & Grants",
    desc: "Track spending, save proof, make reporting easier.",
    optional: false
  }, {
    icon: UserCog,
    title: "People (Staff & HR)",
    desc: "Clear roles, handoffs, basic HR.",
    optional: false
  }, {
    icon: Briefcase,
    title: "Programs & Ops",
    desc: "Simple plans, tracking, reusable updates.",
    optional: false
  }, {
    icon: Database,
    title: "Tools & Data",
    desc: "Folders, templates, and simple tools people can find.",
    optional: false
  }, {
    icon: Heart,
    title: "Fundraising & Donors",
    desc: "Simple donor tracking + routines.",
    optional: true
  }, {
    icon: HandHeart,
    title: "Volunteers",
    desc: "Onboarding, scheduling, hours tracking.",
    optional: true
  }];
  return <section id="framework" className="py-24 md:py-32 bg-nim-cloud relative overflow-hidden">
      <div className="relative max-w-6xl mx-auto px-6 lg:px-12">
        {/* Section header */}
        <div className="text-center mb-16 md:mb-20">
          <motion.h2 initial={{
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-6 mb-12">
          {coreAreas.filter(a => !a.optional).map((area, index) => <motion.article key={index} initial={{
          opacity: 0,
          y: 20
        }} whileInView={{
          opacity: 1,
...
const PricingSection = () => {
  const tiers = [{
    ...
    includes: ["Board & Governance", "Money & Grants (includes Proof Tracker)", "Tools & Files"],
    timeline: "4–5 weeks",
    badge: null,
    ...
    currency: "CAD",
    bestFor: "1–4 grants or regular funder reporting.",
    includes: ["Board & Governance", "Money & Grants (includes Proof Tracker)", "People (Staff & HR)", "Volunteers", "Tools & Files"],
    ...
    currency: "",
    bestFor: "5+ grants, multiple programs, or 25+ staff.",
    includes: ["Everything in Core 5", "Programs & Ops", "Fundraising & Donors"],
    timeline: "Custom (typically 6–10 weeks)",
    badge: null,
    cta: "Request Custom Scope"
  }];
  return <section id="pricing" className="py-24 md:py-32 bg-nim-navy relative overflow-hidden">
      <div className="relative max-w-6xl mx-auto px-6 lg:px-12">
        {/* Section header */}
        ...
        <div className="grid lg:grid-cols-3 gap-6 lg:gap-8 mb-12">
          {tiers.map((tier, index) => <motion.article key={index} initial={{
          opacity: 0,
          y: 24
        }} whileInView={{
          opacity: 1,
          ...
          y: -6
        }} className={`group relative rounded-2xl p-7 lg:p-8 transition-all ${tier.badge ? 'bg-white border-2 border-nim-mint' : 'bg-white/5 border border-white/10 hover:bg-white/10'}`}>
              {tier.badge && <span className="absolute -top-3.5 left-6 px-4 py-1.5 bg-nim-mint text-nim-navy text-xs font-bold tracking-wide rounded-full">
                  {tier.badge}
                </span>}
              ...
              <p className={`text-sm mb-6 pb-6 leading-relaxed ${tier.badge ? 'border-b border-nim-mist text-nim-slate' : 'border-b border-white/10 text-white/60'}`}>
                <span className={tier.badge ? 'text-nim-slate font-medium' : 'text-white/40 font-medium'}>Best for:</span> {tier.bestFor}
              </p>

              <div className="space-y-3.5 mb-6">
                {tier.includes.map((item, i) => <div key={i} className="flex items-start gap-3">
                    <div className={`w-5 h-5 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5 ${tier.badge ? 'bg-nim-purple/20' : 'bg-nim-mint/20'}`}>
              ...
              <div className="space-y-3 mb-7">
                ...
                {tier.insurance && <div className="flex items-center gap-2.5">
              ...
              <a href={CALENDLY_BOOKING_URL} target="_blank" rel="noopener noreferrer" className={`w-full inline-flex items-center justify-center gap-2 px-6 py-3.5 font-semibold rounded-xl text-sm transition-all ${tier.badge ? 'bg-nim-navy text-white hover:bg-nim-navy/90' : 'bg-white/10 text-white hover:bg-white/20'}`}>
                {tier.cta}
                <ArrowRight className="w-4 h-4" />
              </a>
            </motion.article>)}
...
const DeliverablesSection = () => {
  ...
  return <section id="deliverables" className="py-20 md:py-28 bg-white" aria-labelledby="deliverables-heading">
      <div className="max-w-4xl mx-auto px-6 lg:px-8">
        ...
        <header className="mb-12 md:mb-16">
          ...
          <h2 id="deliverables-heading" className="text-3xl md:text-4xl font-bold text-nim-navy mb-4">
            What we install (not just advise)
          </h2>
        ...
        <div className="mb-14" role="region" aria-label="Core 5 Domains">
          ...
          <div className="divide-y divide-nim-mist">
            {coreDomains.map((domain, index) => <article key={index} className="py-6 first:pt-0 last:pb-0">
        ...
        <div className="mb-14" role="region" aria-label="Premium Add-Ons">
          ...
          <div className="grid sm:grid-cols-2 gap-6">
            {premiumAddons.map((addon, index) => <article key={index} className="p-5 bg-nim-cloud rounded-xl border border-nim-mist">
        ...
        {/* Training & Handoff */}
        <article className="bg-nim-navy rounded-2xl p-6 md:p-8 mb-12" role="region" aria-label="Training and Handoff">
...
const TimelineSection = () => {
  const weeks = [{
    week: 1,
    title: "Map + set structure",
    desc: "Folders, naming, tracker installed. We audit what you have and build the foundation."
  }, {
    week: "2–3",
    title: "Build proof packs",
    desc: "Using your real data to create organized, funder-ready documentation systems."
  }, {
    week: 4,
    title: "Train staff",
    desc: "Start using the routine. Hands-on sessions so your team owns the process."
  }, {
    week: "5–6",
    title: "Stabilize + handoff",
    desc: "Tighten, document, and transition. Final polish and complete knowledge transfer."
  }];
  const inputs = ["Access to existing files", "List of active grants", "Your current tracking method", "1–2 staff champions"];
  return <section id="timeline" className="py-24 md:py-32 bg-white relative">
      <div className="max-w-5xl mx-auto px-6 lg:px-12">
        ...
        <div className="grid md:grid-cols-4 gap-4 lg:gap-6 mb-16">
          {weeks.map((item, index) => <motion.article key={index} initial={{
          opacity: 0,
          y: 24
        }} whileInView={{
          opacity: 1,
          ...
          y: -6
              ...
              {index < weeks.length - 1 && <div className="hidden md:block absolute top-10 -right-3 lg:-right-4 w-6 lg:w-8 h-0.5 bg-nim-mist" />}
        ...
        {/* Required Inputs */}
        <motion.div className="bg-nim-cloud border border-nim-mist rounded-2xl p-8 lg:p-10" initial={{
        opacity: 0,
        y: 24
      }} whileInView={{
        opacity: 1,
        ...
        once: true
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            {inputs.map((input, index) => <motion.div key={index} initial={{
            opacity: 0,
            x: -10
          }} whileInView={{
            opacity: 1,
...
const GuaranteeSection = () => {
  const insurance = ["2 check-ins per month", "48-hour response for questions", "One refresh training", "Light template/process updates within scope"];
  return <section id="guarantee" className="py-24 md:py-32 bg-nim-cloud relative">
...
const FAQSection = () => {
  ...
  const faqs = [{
    ...
    a: "No. We help you build systems that make reporting easier and funder relationships smoother, but funding decisions are made by funders."
  }, {
    q: "Are you an audit firm?",
    a: "No. We're an operations and systems consultancy. We don't provide audit, legal, or tax advice."
  }, {
    q: "How fast can you start?",
    a: "Usually within 1–2 weeks of signed agreement and deposit. We'll confirm timing on the fit call."
  }, {
    q: "What if we're 25+ staff?",
    a: "You'll likely need Premium 7 or a custom scope. Book a call and we'll assess together."
  }, {
    q: "What tools do you use?",
    a: "We work inside the tools you already have: Google Workspace, Microsoft 365, QuickBooks, Xero, etc. No new software required."
  }, {
    q: "Will you work with our internal hire/contractor?",
    a: "Yes. We can collaborate with your team or train them to maintain the systems we build."
  }, {
    q: "What's not included?",
    a: "Bookkeeping, tax prep, legal advice, full HR policy development, and custom software builds."
  }, {
    q: "How do payments work?",
    a: "50% deposit to start, 50% on delivery. We can invoice as capacity building if that helps with funder reporting."
  }];
  return <section id="faq" className="py-24 md:py-32 bg-white relative">
      <div className="max-w-4xl mx-auto px-6 lg:px-12">
        {/* Section header */}
        <div className="text-center mb-16">
          <motion.span initial={{
        ...
        <div className="space-y-4">
          ...
          delay: index * 0.05
                ...
                ${openFaq === index ? 'border-nim-purple/30' : 'border-nim-mist hover:border-nim-purple/20'}
              `}>
              <button onClick={() => setOpenFaq(openFaq === index ? null : index)} className="w-full flex items-center justify-between p-6 text-left">
                ...
                <div className={`
                  ...
                  ${openFaq === index ? 'bg-nim-purple/10 text-nim-purple rotate-180' : 'bg-nim-mist text-nim-slate group-hover:bg-nim-purple/10'}
                `}>
        ...
        once: true
          ...
          <p className="text-sm text-nim-slate">
            ...
            <a href="mailto:hello@nimara.ca" className="text-nim-purple hover:text-nim-navy underline underline-offset-4 transition-colors">
              Reach out directly
            </a>
          </p>
        </motion.div>
...
const FinalCTASection = () => {
  return <section id="cta" className="py-28 md:py-36 lg:py-44 bg-nim-navy">
...
const FooterMicrocopy = () => {
  return <div className="bg-nim-navy border-t border-white/10 py-6">
...
const CapacityBuildout = () => {
  return <MotionPreferencesProvider>
