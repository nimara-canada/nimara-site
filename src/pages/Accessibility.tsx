  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Nimara's commitment to accessibility for people with disabilities. Learn about our efforts to make nonprofit consulting accessible across Canada."
        />
