...
const lookingFor = ["Former ED, COO, Director, or VP-level operators", "Program and operations leaders", "Finance operators (bookkeeping, compliance, reporting)", "Governance and policy specialists", "People and capacity builders (HR, team development)", "Project delivery leads"];
const weValue = ["Calm execution under pressure", "Clear thinking and practical systems", "Clean documentation and handoffs", "Respect for stretched nonprofit teams"];
const tracks = [{
...
const projectTypes = [{
  title: "NOHC Baselines",
  desc: "Organizational health assessments"
}, {
  title: "Finance Systems",
  desc: "Budgets, tracking, compliance"
}, {
  title: "Governance Foundations",
  desc: "Boards, policies, structure"
}, {
  title: "Operations Workflows",
  desc: "SOPs, documentation, processes"
}, {
  title: "People & Capacity",
  desc: "HR, hiring, team development"
}];
const faqs = [{
...
const Partners = () => {
  ...
  return <>
      <Helmet>
        ...
        <meta name="description" content="Join Nimara's national team of nonprofit operators. Remote, project-based consulting for former EDs, COOs, and senior operators across Canada." />
      ...
      paddingTop: 'calc(var(--announcement-height, 0px) + 5rem)'
    }}>
        {/* Hero Section */}
          ...
          <div className="container mx-auto px-6 sm:px-8 lg:px-16 py-32 md:py-40">
            <div className="max-w-4xl">
              ...
              delay: 0.8
                ...
                <Button size="lg" onClick={() => window.open(getTypeformUrl(), '_blank')} className="bg-white text-secondary-background hover:bg-white/95 rounded-none px-10 py-7 text-sm tracking-wide font-medium">
                  Check Your Eligibility
                </Button>
                <a href="mailto:partnerships@nimara.ca" className="text-white/50 hover:text-white/80 text-sm tracking-wide transition-colors duration-500 border-b border-white/20 hover:border-white/40 pb-1">
                  Ask a question
                </a>
              </motion.div>
        ...
        <section className="bg-background py-28 md:py-36 border-t border-border/30">
          <div className="container mx-auto px-6 sm:px-8 lg:px-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-16 lg:gap-20">
              {importantTerms.map((term, index) => <motion.div key={index} initial={{
              opacity: 0
            }} whileInView={{
              opacity: 1
            }} viewport={{
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 lg:gap-32">
              ...
              duration: 0.8
                ...
                <div className="space-y-6">
                  {lookingFor.map((item, index) => <div key={index} className="flex gap-8">
              ...
              delay: 0.2
                ...
                <div className="space-y-6">
                  {weValue.map((item, index) => <div key={index} className="flex gap-8">
                      <span className="text-white/20 text-xs font-light tracking-wider w-5 flex-shrink-0 pt-1">
                        —
                      </span>
        ...
        <section className="bg-background py-28 md:py-36 border-t border-border/30">
          <div className="container mx-auto px-6 sm:px-8 lg:px-16">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-20 lg:gap-32">
              ...
              <div className="lg:col-span-8">
                <div className="space-y-0">
                  {tracks.map((track, index) => <motion.div key={index} initial={{
                  opacity: 0
                }} whileInView={{
                  opacity: 1
                }} viewport={{
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 lg:gap-32">
              ...
              delay: 0.2
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-5">
                  {projectTypes.map((item, index) => <div key={index} className="flex items-baseline gap-5">
          ...
          <div className="container mx-auto px-6 sm:px-8 lg:px-16 max-w-4xl">
            ...
            <div className="space-y-0">
              ...
              delay: index * 0.08
                  ...
                  <button onClick={() => setOpenFaq(openFaq === index ? null : index)} className="w-full flex items-center justify-between py-8 text-left">
                    <span className="text-foreground/80 font-medium pr-8">{faq.question}</span>
                    <ChevronDown className={`w-5 h-5 text-muted-foreground/40 transition-transform duration-300 flex-shrink-0 ${openFaq === index ? 'rotate-180' : ''}`} />
                  </button>
                  <AnimatePresence>
          ...
          <div className="container mx-auto px-6 sm:px-8 lg:px-16">
            <div className="max-w-2xl mx-auto text-center">
              ...
              delay: 0.3
                ...
                <Button size="lg" onClick={() => window.open(getTypeformUrl(), '_blank')} className="bg-white text-secondary-background hover:bg-white/95 rounded-none px-14 py-7 text-sm tracking-wide font-medium">
                  Check Your Eligibility
                </Button>
              </motion.div>
