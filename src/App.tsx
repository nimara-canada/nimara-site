...
import SmartTeamCohortFAQ from "./pages/SmartTeamCohortFAQ";
...
import FreeNOHC from "./pages/FreeNOHC";
      ...
      <TooltipProvider>
        ...
        <BrowserRouter>
          <Routes>
            ...
            <Route path="/book-a-call" element={<Navigate to="/capacity-buildout" replace />} />
            ...
            <Route path="/check" element={<FreeNOHC />} />
            <Route path="/free-check" element={<FreeNOHC />} />
