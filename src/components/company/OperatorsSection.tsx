...
export const OperatorsSection = () => {
  return <section className="container mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24 lg:py-32 bg-background">
      <div className="max-w-6xl mx-auto">
        ...
        duration: 0.5
          ...
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto leading-relaxed">Nimara is built by operators who have served as fund managers, board members, and backbone roles across nonprofits and public-interest work. We care more about working systems than glossy reports.</p>
        </motion.div>

        <motion.div variants={containerVariants} initial="hidden" whileInView="visible" viewport={{
        once: true
      }} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          {operators.map(operator => <motion.div key={operator.name} variants={cardVariants}>
              <Card className="p-8 text-center transition-all duration-300 hover:-translate-y-2 hover:shadow-xl bg-card border-border">
                <Avatar className="w-32 h-32 mx-auto mb-6 ring-4 ring-primary/10">
                  <AvatarImage src={operator.image} alt={operator.alt} className="object-cover" />
        ...
        delay: 0.4
          ...
          <a href="https://www.notion.so/Consultant-Hire-2bb227f1ee3a8018b693d47e9610c583" target="_blank" rel="noopener noreferrer" className="inline-flex items-center text-primary hover:text-primary/80 font-medium transition-colors group">
