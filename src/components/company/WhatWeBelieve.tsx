const features = [
  {
    ...
    title: "Outcome first.",
    description: "We define \"what done looks like\" before work begins.",
  },
  {
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    description: "We keep pace and clear blockers.",
  },
  {
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description: "Apples-to-apples decisions.",
  },
  {
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description: "Deliverables are easy to find and review.",
  },
  {
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {features.map((feature, index) => (
            <div key={index} className="flex items-start gap-4 bg-[#F8F9FC] border border-[#E5E7EB] rounded-2xl p-6">
              <div className="w-10 h-10 rounded-full bg-[#6945D8] text-white flex items-center justify-center flex-shrink-0">
                {feature.icon}
              </div>
              <div>
