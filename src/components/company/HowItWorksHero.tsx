      ...
      <div className="relative container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
        <div className="py-20 sm:py-24 lg:py-28 pb-8 sm:pb-12 lg:pb-16">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            {/* Text Content */}
            <motion.div variants={containerVariants} initial="hidden" animate="visible" transition={{
            duration: 0.6,
            ease: "easeOut"
          }} className="order-2 lg:order-1">
              {/* Eyebrow */}
              <motion.div variants={itemVariants} className="inline-flex items-center gap-2 text-sm font-medium text-slate-600 mb-4">
                <span className="block w-8 h-[1px] bg-slate-300" />
                How Nimara works in practice
              </motion.div>
              
              {/* Heading */}
              <motion.h1 variants={itemVariants} className="text-4xl sm:text-5xl lg:text-5xl font-bold text-slate-900 leading-tight mb-6">
              ...
              {/* Subheading */}
              <motion.p variants={itemVariants} className="text-lg text-slate-600 leading-relaxed mb-8 max-w-xl">This page walks through the Nimara model, the steps in a typical project and how we manage quality, risk and refunds.</motion.p>
              ...
              <motion.div variants={itemVariants} className="flex flex-col gap-4 mb-6">
                ...
                <Link to="/refund-policy" className="group inline-flex items-center justify-center gap-2 bg-white text-slate-700 px-6 py-3.5 rounded-lg font-medium border border-slate-200 transition-all hover:bg-slate-50 hover:border-slate-300 hover:scale-[1.02] hover:shadow-md">
              ...
              <motion.p variants={itemVariants} className="text-sm text-slate-500">
                ...
                <Link to="/about" className="text-[#6945D8] hover:text-[#5a38c7] underline underline-offset-2 transition-colors">
                  About page
                </Link>
                .
              </motion.p>
            ...
            <motion.div variants={visualVariants} initial="hidden" animate="visible" transition={{
            duration: 0.8,
            ease: "easeOut"
              ...
              <div className="relative w-full h-full min-h-[400px] flex items-center justify-center">
                ...
                {/* Process Flow Visual */}
                <svg viewBox="0 0 400 400" className="w-full h-full max-w-md relative z-10" xmlns="http://www.w3.org/2000/svg">
                  {/* Animated path */}
                  <motion.path d="M 100 100 Q 200 80, 300 100 T 300 300" stroke="#6945D8" strokeWidth="2" fill="none" strokeDasharray="5 5" initial={{
                  pathLength: 0,
                  opacity: 0
                }} animate={{
                  pathLength: 1,
                  ...
                  {/* Connecting lines */}
                  <motion.line x1="130" y1="100" x2="170" y2="200" stroke="#6945D8" strokeWidth="1" opacity="0.3" initial={{
                  pathLength: 0
                }} animate={{
                  pathLength: 1
                }} transition={{
                  ...
                  <motion.line x1="230" y1="200" x2="270" y2="300" stroke="#4CBFA6" strokeWidth="1" opacity="0.3" initial={{
                  pathLength: 0
                }} animate={{
                  pathLength: 1
                }} transition={{
                  ...
                  <motion.circle cx="150" cy="150" r="4" fill="#6945D8" opacity="0.2" animate={{
                  y: [-5, 5, -5],
                  opacity: [0.2, 0.4, 0.2]
                }} transition={{
                  duration: 3,
                  ...
                  <motion.circle cx="250" cy="250" r="3" fill="#ACFCE3" opacity="0.4" animate={{
                  y: [5, -5, 5],
                  opacity: [0.4, 0.6, 0.4]
                }} transition={{
                  duration: 3.5,
                  ...
                  <motion.rect x="320" y="180" width="6" height="6" fill="#6945D8" opacity="0.15" rx="1" animate={{
                  rotate: [0, 90, 0],
                  ...
                  <motion.rect x="80" y="220" width="5" height="5" fill="#ACFCE3" opacity="0.3" rx="1" animate={{
                  rotate: [0, -90, 0],
                  opacity: [0.3, 0.5, 0.3]
                }} transition={{
                  duration: 3.8,
