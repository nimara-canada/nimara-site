      ...
      >
        ...
        <div className="flex items-center gap-3 mb-4">
          <div className="w-10 h-10 rounded-xl bg-nim-purple/15 flex items-center justify-center">
            <Handshake className="w-5 h-5 text-nim-purple" />
          </div>
          <span className="text-base font-semibold text-nim-navy">Partners:</span>
        </div>
        ...
        <div className="flex flex-wrap gap-2">
          <span className="px-3 py-1 rounded-full bg-nim-purple/10 text-nim-purple text-xs font-medium">Funders</span>
          <span className="px-3 py-1 rounded-full bg-nim-purple/10 text-nim-purple text-xs font-medium">Capacity builders</span>
        </div>
      </motion.div>
    </motion.div>
  </div>
