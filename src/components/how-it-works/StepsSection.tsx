...
import { Check, Calendar, FileCheck, Settings, Users, HandHeart } from 'lucide-react';
      ...
      >
        ...
        >
          ...
          <div className="flex items-center gap-2 sm:gap-3 mb-2 sm:mb-3">
            ...
            <span className="text-sm sm:text-base font-semibold text-secondary-background">{step.name}</span>
          </div>
          ...
          <div className="bg-muted rounded-lg p-3 border border-border">
            <div className="flex items-baseline gap-1.5 mb-0.5">
              ...
              <span className="text-xs sm:text-sm text-muted-foreground">{step.visual.statLabel}</span>
            </div>
            <p className="text-xs text-muted-foreground mb-2">{step.visual.substat}</p>
            <div className={`inline-flex items-center gap-1.5 px-2 py-0.5 rounded-full text-xs font-semibold ${badgeColors[step.visual.badge.color as BadgeColor]}`}>
      ...
      <div className="bg-accent/20 rounded-xl p-4 border border-accent/30">
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-secondary-background font-medium">{step.youGet}</p>
          </div>
        </div>
      </div>
    </motion.article>
