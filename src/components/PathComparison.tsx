        ...
        delay: 0.2
          ...
          <div className="divide-y divide-border">
            ...
            delay: index * 0.05
                ...
                <div className="relative p-4 sm:p-5 flex items-center justify-center border-l-2 border-r-2 border-primary/40 bg-primary/5 shadow-[inset_0_0_15px_-8px_rgba(105,69,216,0.2),-4px_0_15px_-10px_rgba(105,69,216,0.15),4px_0_15px_-10px_rgba(105,69,216,0.15)]">
                  <AnimatePresence>
          ...
          <div className="grid grid-cols-3 border-t border-border bg-muted/30">
            ...
            <div className="relative p-4 sm:p-6 flex justify-center border-l-2 border-r-2 border-b-2 border-primary/40 bg-primary/5 rounded-br-2xl shadow-[0_10px_20px_-10px_rgba(105,69,216,0.3)]">
              <AnimatePresence>
                {highlightedPath === "b" && <motion.div className="absolute inset-0 bg-primary/10" initial={{
                opacity: 0
              }} animate={{
