          ...
          <div className="max-w-xl">
            ...
            <div className={`space-y-4 mb-10 sm:mb-16 transition-all duration-1200 delay-300 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                <a href="/health-score" className="group relative px-6 sm:px-8 py-3.5 sm:py-4 overflow-hidden rounded-xl bg-accent text-accent-foreground font-semibold shadow-soft transition-all duration-500 hover:shadow-lg hover:scale-[1.02] text-sm sm:text-base" onMouseEnter={() => setIsHovering(true)} onMouseLeave={() => setIsHovering(false)}>
