    ...
    <section className="py-16 lg:py-24">
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start">
          ...
          <div className="bg-card border border-border rounded-2xl p-6 lg:p-8 shadow-md" id="form_3quotes">
            ...
            {showOneMorePanel && (
              <div 
                className="mt-6 border border-border rounded-2xl p-6 bg-card/50"
                id="panel_one_more_thing"
                role="region"
              ...
              >
                ...
                <Collapsible open={isPanelExpanded} onOpenChange={setIsPanelExpanded}>
                  {!isPanelExpanded ? (
                    ...
                    <CollapsibleContent className="space-y-4 motion-safe:animate-accordion-down motion-reduce:animate-none">
                      <div className="space-y-2">
                      ...
                      <div className="space-y-2">
                        ...
                        <Select 
                          ...
                          onValueChange={(value) => setOptionalData({ ...optionalData, om_role: value })}
                        >
            ...
            {showOneMorePanel && !isPanelExpanded && !saveSuccess && (
