...
import ProofTrailStrip from "./landing/ProofTrailStrip";
...
const HeroSection = () => {
  ...
  return (
    ...
    >
      ...
      >
        <div className="flex-1 w-full max-w-3xl lg:max-w-4xl xl:max-w-5xl mx-auto px-6 lg:px-12 xl:px-16 py-24 lg:py-32 xl:py-40 flex flex-col justify-center">
          ...
          <div className="text-center">
            ...
            <h1 
              ...
              className="mb-8 md:mb-10 text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold text-white leading-[1.05] tracking-tight"
            >
            ...
            <p 
              ...
              className="text-lg md:text-xl leading-snug max-w-[50ch] mx-auto mb-10 text-white/80"
            >
            ...
            <ul 
              ...
              className="space-y-3 mb-6 max-w-md mx-auto text-left" 
            ...
            {/* Proof Trail Strip */}
            <div style={revealStyle(275)} className="mb-10">
              <ProofTrailStrip variant="dark" size="sm" />
            </div>

            {/* CTAs - UNCHANGED ORDER AND TEXT */}
            <div 
            ...
            <div style={revealStyle(400)} className="mt-8">
              <p className="text-sm text-white/50 tracking-[0.01em]">
      ...
      <motion.div 
        ...
        aria-hidden="true"
      >
        <span style={revealStyle(800)} className="text-[11px] uppercase tracking-[0.2em] text-white/50">
          Scroll
        </span>
        <motion.div 
