          ...
          >
            <div className="grid grid-cols-12 gap-4 lg:gap-8 py-10 lg:py-14 border-t border-border hover:bg-muted/30 transition-colors duration-300">
              <div className="col-span-12 lg:col-span-4">
                ...
                <p className="text-sm text-muted-foreground mt-2">1–4 weeks · One issue, one clear fix</p>
              </div>
              
              <div className="col-span-12 lg:col-span-5">
                <p className="text-muted-foreground leading-relaxed mb-4">
                  We fix the problem and leave you a simple way to run it.
                </p>
                <ul className="space-y-2">
                  {["Deadline or audit pressure", "Something is broken right now", "You need clarity this month"].map((item, i) => (
          ...
          >
            <div className="grid grid-cols-12 gap-4 lg:gap-8 py-10 lg:py-14 border-t border-border hover:bg-muted/30 transition-colors duration-300">
              <div className="col-span-12 lg:col-span-4">
                ...
                <p className="text-sm text-muted-foreground mt-2">Start free · Go deeper if needed</p>
              </div>
              
              <div className="col-span-12 lg:col-span-5">
                <p className="text-muted-foreground leading-relaxed mb-4">
                  Start with a free check, then we recommend the next step.
                </p>
                <ul className="space-y-2">
                  {["More than one area feels messy", "You want repeatable systems", "You need funder-ready basics"].map((item, i) => (
                    <li key={i} className="flex items-center gap-2 text-sm text-muted-foreground">
                      <span className="w-1 h-1 rounded-full bg-muted-foreground/50" />
                      {item}
                    </li>
              ...
              <div className="col-span-12 lg:col-span-3 lg:text-right lg:self-center">
                <button
                  ...
                  className="group/btn inline-flex items-center gap-3 text-foreground font-medium"
                >
                  <span className="group-hover/btn:text-primary transition-colors">Start the free check (4 min)</span>
                  <span className="w-8 h-px bg-foreground group-hover/btn:w-12 group-hover/btn:bg-primary transition-all duration-300" />
                </button>
              </div>
            </div>
