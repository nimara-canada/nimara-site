...
export const FinalCTA = () => {
  return <section className="py-16 sm:py-20 md:py-28 lg:py-32 xl:py-40 bg-nim-navy">
      <div className="container max-w-4xl mx-auto px-4 text-center">
        ...
        {/* Button */}
        <Button asChild size="lg" variant="secondary" className="w-full sm:w-auto bg-white text-nim-navy hover:bg-white/90 px-6 sm:px-8 md:px-10 py-4 sm:py-5 md:py-6 lg:py-7 text-sm sm:text-base md:text-lg font-semibold rounded-full transition-all duration-300">
